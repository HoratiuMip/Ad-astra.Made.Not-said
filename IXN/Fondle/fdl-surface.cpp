...
struct MyKeySeqTrigger : public Descriptor {
    IXN_DESCRIPTOR_STRUCT_NAME_OVERRIDE( "MyKeySeqTrigger" );
    ...
    void init( Surface& surf, IXN_COMMS_ECHO_ARG ) {
...
int main() {
    ixN::initial_uplink( 0, nullptr, 0, nullptr, nullptr );

    Surface surface{ "IXN Surface", Crd2{ 64 }, Vec2{ 512 }, SURFACE_STYLE_LIQUID};
    ...
    ixN::final_downlink( 0, nullptr, 0, nullptr, nullptr );
}