...
`cmake .. -DGLM_BUILD_TESTS=OFF -DBUILD_SHARED_LIBS=OFF -DIXT_PREPROCESSOR_DEFINITIONS=IXT_OS_WINDOWS;IXT_GL_OPEN_GL -DIXT_FONDLES_TO_BUILD=` <br>

`cmake .. -DGLM_BUILD_TESTS=OFF -DBUILD_SHARED_LIBS=OFF -DIXT_PREPROCESSOR_DEFINITIONS=IXT_OS_WINDOWS;IXT_GL_OPEN_GL;IXT_GL_DIRECT_2D1 -DIXT_FONDLES_TO_BUILD=` <br>
