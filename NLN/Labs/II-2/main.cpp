#include <NLN/Framework/imgui-opengl3.hpp>
...
protected:
    static NLN::DWORD _login_loop( double elapsed ) {
        static NLN::Ticker   tick{ NLN::ticker_lap_epoch_init_t{} };
    ...
    static NLN::DWORD _logged_loop( double elapsed ) {
        static int _constructor = ( [] () static -> int {
            return 0;
        } )();
...
public:  
    static NLN::DWORD loop( double elapsed ) {
...
int main( int argc, char* argv[] ) {
    NLN::Fwk::ImGui_on_OpenGL3 fwk;

    fwk.params.title = "II-2";
    fwk.params.iconify = true;

    static NLN::Fwk::ImGui_on_OpenGL3::frame_callback_t loops[] = {
        Ex1::loop
    };
