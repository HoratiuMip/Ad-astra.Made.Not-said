...
struct MyKeySeqTrigger : public Descriptor {
    NLN_DESCRIPTOR_STRUCT_NAME_OVERRIDE( "MyKeySeqTrigger" );
    ...
    void init( Surface& surf, NLN_COMMS_ECHO_ARG ) {
        ...
        echo( this, EchoLevel_Info ) << "MyKeySeqTrigger engaged.";
    }
...
int main() {
    NLN::initial_uplink( 0, nullptr, 0, nullptr, nullptr );

    Surface surface{ "NLN Surface", Crd2{ 64 }, Vec2{ 512 }, SURFACE_STYLE_LIQUID};
    ...
    NLN::final_downlink( 0, nullptr, 0, nullptr, nullptr );
}