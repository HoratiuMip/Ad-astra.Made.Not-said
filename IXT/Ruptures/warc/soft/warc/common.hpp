...
#define   WARC_LOG_RT_INPUT                WARC_LOG_RT( IXT::ECHO_LEVEL_INPUT )
...
#define   WARC_LOG_RT_THIS_INPUT           WARC_LOG_RT_THIS( IXT::ECHO_LEVEL_INPUT )
...
#define   WARC_LOG_RT_THAT_INPUT( that )   WARC_LOG_RT_THAT( that, IXT::ECHO_LEVEL_INPUT )
