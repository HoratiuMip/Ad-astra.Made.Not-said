...
uniform sampler2D IXN_map_lights;
uniform sampler2D IXN_map_cal;
...
void main() {
    ...
    vec4 city_lights = texture( IXN_map_lights, gs_in.tex_crd );
    ...
    vec4 cal = texture( IXN_map_cal, gs_in.tex_crd );
