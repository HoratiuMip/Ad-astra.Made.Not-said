...
WARC_MAIN_PARSE_PROC_FUNC( MAIN::_parse_proc_root_dir ) {
    _WARC_NLN_COMPONENT_DESCRIPTOR( WARC_MAIN_STR"::_parse_proc_root_dir()" );
...
WARC_MAIN_PARSE_PROC_FUNC( MAIN::_parse_proc_n2yo_api_key ) {
    _WARC_NLN_COMPONENT_DESCRIPTOR( WARC_MAIN_STR"::_parse_proc_n2yo_api_key()" );
...
WARC_MAIN_PARSE_PROC_FUNC( MAIN::_parse_proc_n2yo_ip ) {
    _WARC_NLN_COMPONENT_DESCRIPTOR( WARC_MAIN_STR"::_parse_proc_n2yo_ip()" );
...
WARC_MAIN_PARSE_PROC_FUNC( MAIN::_parse_proc_n2yo_bulk_count ) {
    _WARC_NLN_COMPONENT_DESCRIPTOR( WARC_MAIN_STR"::_parse_proc_n2yo_bulk_count()" );
...
WARC_MAIN_PARSE_PROC_FUNC( MAIN::_parse_proc_n2yo_mode ) {
    _WARC_NLN_COMPONENT_DESCRIPTOR( WARC_MAIN_STR"::_parse_proc_n2yo_mode()" );
...
WARC_MAIN_PARSE_PROC_FUNC( MAIN::_parse_proc_earth_imm ) {
    _WARC_NLN_COMPONENT_DESCRIPTOR( WARC_MAIN_STR"::_parse_proc_earth_imm()" );
...
WARC_MAIN_PARSE_PROC_FUNC( MAIN::_parse_proc_earth_imm_lens_sens ) {
    _WARC_NLN_COMPONENT_DESCRIPTOR( WARC_MAIN_STR"::_parse_proc_earth_imm_lens_sens()" );
...
WARC_MAIN_PARSE_PROC_FUNC( MAIN::_parse_proc_earth_imm_lens_fov ) {
    _WARC_NLN_COMPONENT_DESCRIPTOR( WARC_MAIN_STR"::_parse_proc_earth_imm_lens_fov()" );
...
WARC_MAIN_PARSE_PROC_FUNC( MAIN::_parse_proc_earth_imm_shake_decay ) {
    _WARC_NLN_COMPONENT_DESCRIPTOR( WARC_MAIN_STR"::_parse_proc_earth_imm_shake_decay()" );
...
WARC_MAIN_PARSE_PROC_FUNC( MAIN::_parse_proc_earth_imm_shake_cross_count ) {
    _WARC_NLN_COMPONENT_DESCRIPTOR( WARC_MAIN_STR"::_parse_proc_earth_imm_shake_cross_count()" );
...
WARC_MAIN_PARSE_PROC_FUNC( MAIN::_parse_proc_astro_ref_vernal_equinox_ts ) {
    _WARC_NLN_COMPONENT_DESCRIPTOR( WARC_MAIN_STR"::_parse_proc_astro_ref_vernal_equinox_ts()" );
...
WARC_MAIN_PARSE_PROC_FUNC( MAIN::_parse_proc_astro_ref_first_january_ts ) {
    _WARC_NLN_COMPONENT_DESCRIPTOR( WARC_MAIN_STR"::_parse_proc_astro_ref_first_january_ts()" );
...
WARC_MAIN_PARSE_PROC_FUNC( MAIN::_parse_proc_from_config ) {
    _WARC_NLN_COMPONENT_DESCRIPTOR( WARC_MAIN_STR"::_parse_proc_from_config()" );
    ...
    size_t sz = NLN::File::byte_count( file );
    NLN::UPtr< char[] > buffer{ ( char* )malloc( sz + 1 ) };
...
int MAIN::_parse_opts( int argc, char* argv[] ) {
    _WARC_NLN_COMPONENT_DESCRIPTOR( WARC_MAIN_STR"::_parse_opts()" );
...
int MAIN::main( int argc, char* argv[] ) {
    ...
    if( this->_earth != nullptr ) {
        this->_earth->set_sat_pos_update_func( [ &, this ] ( sat::NORAD_ID norad_id, std::deque< sat::POSITION >& positions ) -> imm::EARTH_SAT_UPDATE_RESULT {
            _WARC_NLN_COMPONENT_DESCRIPTOR( WARC_MAIN_STR"::lambda::sat_updater()" );
