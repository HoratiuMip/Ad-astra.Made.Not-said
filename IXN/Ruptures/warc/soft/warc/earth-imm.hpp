...
_WARC_IXN_COMPONENT_DESCRIPTOR( WARC_IMM_STR );
...
#define WARC_IMM_CTRL_INSERT_TOKENS_CLEAR ( 1 )
    ...
    struct _CRS_INFO {
        ...
        float         _x_last         = 0.0;
        float         _dx_last        = 0.0;
        ixN::Ticker   _x_cross_tick   = { ixN::ticker_lap_epoch_init_t{} };
    } crs_info;

    struct _CIN_INFO {
        int           trigger_count   = 0;
        ixN::Ticker   tick            = { ixN::ticker_lap_epoch_init_t{} };
    } cin_info;
...
class EARTH : public ixN::Descriptor {
public:
    IXN_DESCRIPTOR_STRUCT_NAME_OVERRIDE( WARC_IMM_STR"::EARTH" );
...
_WARC_PROTECTED:
    ...
    ixN::SPtr< EARTH_PARAMS >   _params            = { std::make_shared< EARTH_PARAMS >() }; 
...
public:
    ...
    void set_params( ixN::SPtr< EARTH_PARAMS > ptr );
    EARTH_PARAMS& params();
