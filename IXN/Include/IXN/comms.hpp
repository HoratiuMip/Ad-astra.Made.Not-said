...
#define  IXN_COMMS_ECHO_ARG             _ENGINE_NAMESPACE::_ENGINE_COMMS_ECHO_ARG
#define  IXN_COMMS_ECHO_NO_DFT_ARG      _ENGINE_NAMESPACE::_ENGINE_COMMS_ECHO_NO_DFT_ARG

/* VVV === For backward compatibility. === VVV */
#define  _ENGINE_COMMS_ECHO_RT_ARG      Echo echo = { nullptr }
#define  IXN_COMMS_ECHO_RT_ARG          _ENGINE_NAMESPACE::_ENGINE_COMMS_ECHO_RT_ARG
