/*===== NLN Dear ImGui on OpenGL3 framework - Vatca "Mipsan" Tudor-Horatiu
|
|=== DESCRIPTION
> 
|
...
public:
    struct {
        ...
        const char*        title                 = "NLN::Fwk::ImGui_on_OpenGL3";
        int                width                 = 64;
        int                height                = 64;
...
public:
    ...
    /* Setup */
        ...
        if( int ret = NLN::begin_runtime( argc, argv, params.runtime_begin_flags, nullptr, nullptr ); ret != 0 ) return ret;
    ...
    /* Last checks */
        ...
        return NLN::end_runtime( argc, argv, params.runtime_end_flags, nullptr, nullptr );
    }
